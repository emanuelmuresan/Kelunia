...
function createAuth() {
  ...
  try {
    return initializeAuth(app, {
      persistence: isNativeShell() ? indexedDBLocalPersistence : browserLocalPersistence,
    });
  } catch {
    return getAuth(app);
  }
...
export function ensureAuthPersistence() {
  ...
  const persistence = isNativeShell() ? indexedDBLocalPersistence : browserLocalPersistence;
